        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Composition_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "GenreId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Composition_Texts_TextId",
                        column: x => x.TextId,
                        principalTable: "Texts",
                        principalColumn: "TextId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Composition_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Composition_CompositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Composition_GenreId",
                table: "Composition",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_Composition_TextId",
                table: "Composition",
                column: "TextId");

            migrationBuilder.CreateIndex(
                name: "IX_Composition_UserId",
                table: "Composition",
                column: "UserId");
        }
